        ...
        <div class="col-xl-3 col-sm-6">
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                <p class="text-sm mb-0 text-capitalize">Completed Bookings</p>
              ...
              <tbody>
                ...
                if ($result->num_rows > 0) {
                  ...
                  while($row = $result->fetch_assoc()) {
                    ...
                    // echo '<button type="button" class="btn btn-primary view-history-btn" data-booking_id="' . $row['booking_id'] . '">assign</button>';
                    echo "<button class='btn btn-primary view-history-btn' id='myBtn' data-id='" . $row['id'] . "'>Assign</button>";
                    echo "</td>";
                    echo "</tr>";
                  }
                } else {
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div class="form-group">
                    ...
                    <select id="booking_list" class="form-control">
